...
I'm an AI/ML researcher specializing in **smart grids, power systems, and innovation ecosystems**.  
My work bridges data-driven modeling and real-world infrastructure challenges.

- 🏛️ Working on NSF-funded **Innovation Engine Project** (Texoma Region)
- ⚡ Research in **Transportation Electrification** and smart grid security
- 📊 Developing **Graph Neural Network** frameworks for cross-sectoral innovation analysis
- 🌆 Urban analytics pipeline for **DFW metropolitan area** (2015–2024)

---

## 🔑 Research Expertise

- Artificial Intelligence & Machine Learning for Power Systems
- Graph Neural Networks (R-GCN) for Innovation Ecosystems
- Electricity Theft Detection & Grid Cybersecurity
- Smart Grid Optimization & Demand Response
- Urban Analytics & Transportation Electrification
